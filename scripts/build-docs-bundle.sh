...
#   pam-certauth-docs-<version>.tar.gz
#   pam-certauth-docs-<version>.tar.gz.sha256
#   pam-certauth-docs-<version>.tar.gz.streebog256   (if gost-engine present)
#   pam-certauth-docs-<version>.tar.gz.asc           (if GPG_KEY set)
#   pam-certauth-docs-<version>.tar.gz.gost-sig      (if GOST_KEY set)
#
# Determinism:
...
OUT="${OUT_DIR}/pam-certauth-docs-${VERSION}.tar.gz"
