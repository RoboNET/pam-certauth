...
sudo -u vagrant mkdir -p /home/vagrant/pam-certauth-fixtures
cat > /home/vagrant/pam-certauth-fixtures/README.txt <<'EOF'
Drop the following files here before running install-and-test.sh:
  ca.pem            (test CA bundle)
  config.toml       (filled-in pam_certauth config; mountpoint /run/pam_certauth/usb)
...
EOF
chown vagrant:vagrant /home/vagrant/pam-certauth-fixtures/README.txt
