> [!IMPORTANT]
> **Репозиторий заархивирован.** Проект переименован, разработка
> продолжается под именем **Tessera**:
> <https://github.com/RoboNET/tessera>. Этот репозиторий оставлен
> только для истории — обновлений и security-фиксов не будет.
