...
use pam_certauth_core::x509::pinning::SpkiPin;
...
pub enum WireError {
    ...
    #[error("trust: {0}")]
    Trust(#[from] pam_certauth_core::x509::TrustError),
...
pub fn wire(cfg: ValidatedConfig) -> Result<Wired, WireError> {
    ...
    let verifier = OpensslVerifier::new(OpensslVerifierConfig {
        ...
        crl_strict: matches!(
            ...
            pam_certauth_core::config::validated::RevocationMode::Crl
                | pam_certauth_core::config::validated::RevocationMode::CrlThenOcsp
        ),
