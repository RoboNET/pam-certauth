...
//!    no-op.
//! 2. From the explicit `session required pam_certauth.so` after
...
use pam_certauth_core::error::IpcError;
...
///
/// Mirrors `pam_certauth_core::ipc::client::uuid_from_session_id`
