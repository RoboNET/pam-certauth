...
pub fn fixtures_dir() -> PathBuf {
    PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../pam_certauth_core/tests/fixtures")
}
...
pub fn cn_mapping(user: &str, cn: &str) -> pam_certauth_core::config::validated::UserMapping {
...
pub fn run_flow_with(
    p12_name: &str,
    mappings: Vec<pam_certauth_core::config::validated::UserMapping>,
    _acl: (),
    pam_user: &str,
    pin: &str,
    crl_pems: Vec<Vec<u8>>,
