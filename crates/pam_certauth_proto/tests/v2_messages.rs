...
use pam_certauth_proto::{ClientMessage, ServerMessage};
...
fn no_active_session_error_code_is_1200() {
    assert_eq!(pam_certauth_proto::error_codes::NO_ACTIVE_SESSION, 1200);
}

#[test]
fn protocol_version_is_two() {
    assert_eq!(pam_certauth_proto::PROTOCOL_VERSION, 2);
}
