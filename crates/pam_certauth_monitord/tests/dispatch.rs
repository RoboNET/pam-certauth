...
use pam_certauth_monitord::actions::spawn_action_runner;
use pam_certauth_monitord::logind::LogindActionsTrait;
use pam_certauth_monitord::registry::ActiveSession;
use pam_certauth_monitord::state::{ActionRequest, OnUsbRemoved};
use pam_certauth_monitord::testing::RecordingActions;
