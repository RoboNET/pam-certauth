...
//!
//! See `docs/superpowers/specs/2026-02-21-mac-integrity-design.md` for the
//! full design.  The trait abstracts over the real Astra МКЦ FFI (provided by
//! `libpdp`, gated behind the `astra-mac` feature) and the in-process
//! [`StubBackend`] used on developer hosts and in CI.
