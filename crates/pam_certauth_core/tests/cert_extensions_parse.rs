...
use pam_certauth_core::x509::host_binding_ext::{self, HostBindingExtError, HostDescriptor};
use pam_certauth_core::x509::oids::{HOST_BINDING_OID, USER_BINDING_OID};
use pam_certauth_core::x509::user_binding_ext::{self, UserBindingExtError, UserDescriptor};
