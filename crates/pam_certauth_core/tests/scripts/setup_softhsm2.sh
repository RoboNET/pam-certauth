...
#                       $HOME/.pam_certauth_test/softhsm2)
#   TOKEN_LABEL       — token CKA_LABEL (default: pam_certauth_test)
...
#   export SOFTHSM_RSA_LABEL=pam_certauth_rsa
#   export SOFTHSM_ECDSA_LABEL=pam_certauth_ec_p256
#
...
# 2. Token store
# ---------------------------------------------------------------------------
TESTDIR="${TESTDIR:-$HOME/.pam_certauth_test/softhsm2}"
TOKEN_LABEL="${TOKEN_LABEL:-pam_certauth_test}"
USER_PIN="${USER_PIN:-1234}"
SO_PIN="${SO_PIN:-12345678}"
RSA_LABEL="pam_certauth_rsa"
ECDSA_LABEL="pam_certauth_ec_p256"
